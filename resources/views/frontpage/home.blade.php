        ...
        <div class="carousel-car owl-carousel">
          ...
          <div class="item">
            <div class="car-wrap rounded ftco-animate">
              <div class="img rounded d-flex align-items-end" style="background-image: url({{ asset('storage/' . $motor->gambar_motor) }});"></div>
              <div class="text">
              ...
              <div class="d-grid gap-2 col-6 mx-auto">
                <a href="/view-motor" class="btn btn-primary py-2" style="position: relative; top: -20px;">
                  Details
                </a>
              </div>              
            </div>
