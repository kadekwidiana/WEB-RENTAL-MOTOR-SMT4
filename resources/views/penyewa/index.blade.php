    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
              ...
              <button class="btn btn-danger btn-sm mt-1" data-bs-toggle="modal" data-bs-target="#hapusModal{{ $penyewa->no_paspor }}">
                Hapus
              </button>
              <a href="{{ route('penyewa.edit', $penyewa->no_paspor) }}" class="btn btn-primary btn-sm mt-1">Edit</a>
            </td>
        </tr>
        <!-- Modal Detail -->
        <div class="modal fade" id="paspor{{ $penyewa->no_paspor }}" tabindex="-1" aria-labelledby="pasporModalLabel{{ $penyewa->no_paspor }}" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="pasporModalLabel{{ $penyewa->no_paspor }}">Detail Penyewa</h5>
        ...
        <!-- Modal Hapus -->
        <div class="modal fade" id="hapusModal{{ $penyewa->no_paspor }}" tabindex="-1" aria-labelledby="hapusModalLabel{{ $penyewa->no_paspor }}" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="hapusModalLabel{{ $penyewa->no_paspor }}">Konfirmasi Hapus</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
