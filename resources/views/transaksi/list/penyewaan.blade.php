...
<div class="d-flex">
    ...
    {{-- <div class="mt-3 justify-content-center">
        <form action="{{ route('transaksi.penyewaan') }}" method="GET">
        <div class="row">
            <div class="col">
     ...
     <div class="row mb-2 mt-2">
        <div class="col">
            <form action="{{ route('transaksi.penyewaan') }}" method="GET">
                ...
                <a href="{{ route('transaksi.penyewaan') }}" class="btn btn-secondary"><i class="fas fa-retweet"></i></a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                {{-- @php
                $bulanSekarang = \Carbon\Carbon::now()->format('m');
                $bulanPengembalian = \Carbon\Carbon::parse($transaksi->tgl_selesai)->format('m');
                @endphp

                @if ($bulanPengembalian == $bulanSekarang) --}}
                    <form class="d-inline" action="{{ route('transaksi.destroy', $transaksi->kode_transaksi) }}" method="POST">
                        @csrf
                        @method('delete')
                        <button class="btn btn-danger btn-sm mt-1" onclick="return confirm('Hapus data transaksi ini?')">Hapus</button>
