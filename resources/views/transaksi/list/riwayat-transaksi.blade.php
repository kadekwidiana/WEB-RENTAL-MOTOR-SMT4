...
@section('content')
     ...
     <div class="row mb-2 mt-2">
        <div class="col">
            <form action="{{ route('transaksi.listRiwayatTransaksi') }}" method="GET">
                <div class="input-group mb-3">
                <a href="{{ route('transaksi.listRiwayatTransaksi') }}" class="btn btn-secondary"><i class="fas fa-retweet"></i></a>
  ...
  <table id="div1" class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <button href="" class="btn btn-outline-success btn-sm mt-1" ><i class="fa fa-check-circle" aria-hidden="true"></i>
                    Success</button>
