    ...
    <div class="border p-3 rounded mt-3">
        ...
        <div class="row mt-2">
            ...
            <label for="km_awal">Km Awal</label>
                <input type="number" class="form-control @error('km_awal') is-invalid @enderror" id="km_awal" name="km_awal" value="{{ $transaksi->km_awal }}" placeholder="Kilometer motor awal">
                @error('km_awal')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
